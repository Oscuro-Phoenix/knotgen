                        ...
                        <div className="mt-8 space-y-6">
                          ...
                          <div className="grid gap-4 sm:grid-cols-3">
                            {employeeSuggestions.map((candidate, index) => (
                              <div key={index} className="bg-gray-700/30 rounded-xl p-6 border border-gray-600/50 flex flex-col justify-between">
                                <div> {/* Wrapper for content */}
                                  ...
                                  <div className="space-y-2 text-sm text-purple-200 mb-4">
                                    <p><span className="text-purple-400 font-medium">Education:</span> {candidate.education}</p>
                                    <p><span className="text-purple-400 font-medium">Experience:</span> {candidate.experience}</p>
                                    {/* Phone number display removed */}
                                  </div>
                                </div>
                                {/* Static WhatsApp button for demo */}
                                <a
                                  href={`https://wa.me/91XXXXXXXXXX`} // Replace 91XXXXXXXXXX with your demo WhatsApp number (including country code)
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="mt-auto inline-flex items-center justify-center gap-2 px-4 py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg text-sm font-medium transition-colors duration-200"
                                >
